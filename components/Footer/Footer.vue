...
<template>
  <footer class="bg-primary-dark-blue mt-20">
    <Layout
      class="py-10 flex flex-col lg:flex-row justify-between gap-6 max-w-5xl"
    >
      <div class="flex flex-col lg:flex-row gap-10 lg:gap-32">
        <div class="flex justify-center flex-col gap-2">
          <svg
            class="mx-auto lg:mr-auto"
          ...
          <ul class="flex justify-center gap-3 mt-8 lg:mt-auto">
      ...
      <div class="flex flex-col mt-10 lg:mt-0">
        <Button text="Resquet Invite" class="max-w-[12rem] mx-auto" />
        <p
          class="text-center lg:text-start mt-8 lg:mt-auto text-neutral-grayish-blue text-xs"
        >
