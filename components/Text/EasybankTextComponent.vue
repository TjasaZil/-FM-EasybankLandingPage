<template>
  <div
    class="w-full flex flex-col justify-center items-center py-20 mx-auto lg:-mt-20 bg-neutral-light-grayish-blue relative z-10"
  >
    <div
      class="w-10/12 mx-auto text flex flex-col justify-center content-center text-center max-w-6xl"
    >
      <h2
        class="text-center capitalize text-3xl text-primary-dark-blue lg:text-left"
      >
        Why Choose Easybank?
      </h2>
      <p
      ...
      <div
        class="flex flex-col mx-auto text-center justify-center content-center lg:flex-row lg:text-left lg:justify-between lg:mx-0 max-w-7xl"
      >
        <div
        ...
        >
          <img
            :src="render.img"
            alt="green circular icons"
            class="w-[72px] h-[72px] mx-auto lg:mx-0"
          />
